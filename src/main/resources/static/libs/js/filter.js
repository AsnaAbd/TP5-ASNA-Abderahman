...
(function($) {
		...
		init : function(settings) {
			...
			return this.each(function() {
				...
				var configs = {
					...
					// Entrée qui va filtrer les tables
					'input' : 'input[type=rechercher]',

					'trigger': {

						"event" 	: "keyup", // Événement qui appellera la fonction de filtre dans les tableaux
						'element' 	: undefined // Élément sur lequel l'événement sera appliqué, undefined est l'entrée du filtre lui-même
					},
					...
					'sort'	: false, // Appliquer la fonction de tri des lignes
				...
				// Configuration pour le tirage au sort des tableaux
				if(configs.sort) {
	...
	/ * Ajoutez les lignes à nouveau dans le tableau * /
